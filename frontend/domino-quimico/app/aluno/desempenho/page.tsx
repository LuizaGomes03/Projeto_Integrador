...
export default function DesempenhoPage() {
  ...
  TODOS ESSES DADOS VIRÃO DO BANCO:
      ...
      <header className="sticky top-0 z-40 border-b border-[#E5E7EB] bg-white/90 backdrop-blur">
        ...
        <div className="mx-auto flex max-w-[1400px] items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex h-10 w-10 items-center justify-center rounded-full border border-[#F3D1D1] bg-[#FFF5F5]">
              <FlaskConical className="text-[#DC2626]" size={20} />
            </div>

            <h1 className="text-2xl font-black tracking-[-0.04em] text-[#3A3A3A]">
              Dominó <span className="text-[#DC2626]">Químico</span>
            </h1>
          </div>
          ...
          >
            {/* Arthur:
            avatar real do aluno vindo do backend */}
            <Image
              src="/avatar.png"
              alt="Perfil"
              width={46}
            ...
            <div className="absolute right-0 top-0 h-3 w-3 rounded-full bg-[#DC2626]" />
          </button>
        </div>
      </header>
            ...
            <div className="rounded-[32px] border border-[#E5E7EB] bg-white p-5 shadow-[0_10px_40px_rgba(0,0,0,0.06)] sm:p-6 lg:p-8">
              ...
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="min-w-0">
                  ...
                  {/* Arthur:
                  XP TOTAL do aluno vindo do banco */}
