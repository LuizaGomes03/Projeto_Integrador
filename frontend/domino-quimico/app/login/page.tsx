          ...
          <div className="mt-5 space-y-3.5">
            ...
            <div>
              <div className="mb-3 flex items-center justify-between">
                <label
                  htmlFor="senha"
                  className="text-[9px] font-bold uppercase tracking-[0.24em] text-[#8A8A8A]"
                >
                  Senha de acesso
                </label>
                <button
                  ...
                  className="text-[8px] font-black uppercase tracking-[0.14em] text-[#E12727] transition hover:opacity-70"
                >
                  Esqueci a senha
                </button>
              </div>
