...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-[#faf8f9] to-[#f3eef2] px-4 flex items-center justify-center">
      <div className="w-full max-w-md">
            ...
            <div className="bg-white rounded-lg p-6 z-10 w-full max-w-sm">
              ...
              <div className="flex justify-end gap-2">
                ...
                <button
                  onClick={() => {
                    if (!forgotInput) {
                      alert("Preencha usuário ou email")
                      return
                    }
        ...
        <div className="text-center py-4 text-gray-500 text-xs mt-6">
